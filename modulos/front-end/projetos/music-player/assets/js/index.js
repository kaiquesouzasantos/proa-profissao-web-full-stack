...
class Audio {
  ...
  changeVolume(playerVolumeBtn) {
    audio.volume = playerVolumeBtn.value;
    audio.muted = false;

    if (audio.volume <= 0.1) {
      playerVolumeBtn.children[0].innerHTML = "<i class='bx bx-volume'></i>";
    } else if (audio.volume <= 0.5) {
      playerVolumeBtn.children[0].innerHTML = "<i class='bx bx-volume-low'></i>";
    } else {
      playerVolumeBtn.children[0].innerHTML = "<i class='bx bx-volume-full'></i>";
    }
  }

  muteVolume(playerVolumeBtn) {
    if (!audio.muted) {
      audio.muted = true;
      playerVolumeBtn.children[0].innerHTML = "<i class='bx bx-volume-mute'></i>";
    } else {
      changeVolume();
    }
  }
